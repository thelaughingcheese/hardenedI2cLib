/*
  TwoWireModified.h - TWI/I2C library for Arduino & Wiring
...
#ifndef TwoWireModified_h
#define TwoWireModified_h
...
class TwoWireModified : public Stream
{
  private:
...
extern TwoWireModified WireModified;
